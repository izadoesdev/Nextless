...
export default function OgTestsPage() {
  return (
    <div className="max-w-4xl mx-auto">
      <div className="mb-8">
        <h1 className="text-3xl font-bold mb-2">Open Graph (OG) Tests</h1>
        <p className="text-gray-600 dark:text-gray-400">
          This page will be used to demonstrate the OG-related components from @databuddy/nextless.
        </p>
      </div>
      ...
      <div className="component-display bg-gray-50 dark:bg-gray-900 p-10 text-center">
        ...
        <p className="mb-6">The OG Component implementation is forthcoming.</p>
